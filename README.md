...
### 1.2. [Desoldering - Hút thiếc](https://en.wikipedia.org/wiki/Desoldering)
...
### 1.3. [Soldering iron - Mỏ hàn](https://en.wikipedia.org/wiki/Soldering_iron)

Dùng để hàn chân pin header và các linh kiện khác; nên mua loại có điều chỉnh nhiệt độ chính xác.

### 1.4. [Solder - Thiếc hàn](https://en.wikipedia.org/wiki/Solder)

Hợp kim hàn thường là dạng cuộn dây dùng để liên kết kim loại trên bo mạch.

### 1.5. [Flux - Nhựa thông / Mỡ hàn](https://en.wikipedia.org/wiki/Flux_(metallurgy))
...
### 1.6. [USB-to-serial adapter - Cáp chuyển đổi USB sang UART / TTL](https://en.wikipedia.org/wiki/USB-to-serial_adapter)
...
### 1.7. [Pin header](https://en.wikipedia.org/wiki/Pin_header)

![Pin header male](./IMG/pin_header_male.png)

Mua hàng rào đực đơn hàn vào lỗ cắm UART để nối với dây cắm (jumper wire).

### 1.8. [Jump wire - Dây cắm test (Dupont wire)](https://en.wikipedia.org/wiki/Jump_wire)
...
### 1.9. [Multimeter - Đồng hồ vạn năng](https://en.wikipedia.org/wiki/Multimeter)
