...
- [Opening pick / Pry tool / Spudger](https://en.wikipedia.org/wiki/Spudger): bộ dụng cụ nhựa chuyên dụng dùng để nạy vỏ router không bị toác ngàm, trầy xước hay gãy chốt nhựa.
- [Desoldering - Hút thiếc](https://en.wikipedia.org/wiki/Desoldering)
...
- [Soldering iron - Mỏ hàn](https://en.wikipedia.org/wiki/Soldering_iron): dùng để hàn chân pin header và các linh kiện khác; nên mua loại có điều chỉnh nhiệt độ chính xác.
- [Solder - Thiếc hàn](https://en.wikipedia.org/wiki/Solder): hợp kim hàn thường là dạng cuộn dây dùng để liên kết kim loại trên bo mạch.
- [Flux - Nhựa thông / Mỡ hàn](https://en.wikipedia.org/wiki/Flux_(metallurgy)): chất trợ hàn giúp làm sạch bề mặt kim loại, tăng độ bám dính của chì hàn, giúp mối hàn sáng bóng và hạn chế chập mạch khi hàn các chân linh kiện nhỏ.
- [USB-to-serial adapter - Cáp chuyển đổi USB sang UART / TTL](https://en.wikipedia.org/wiki/USB-to-serial_adapter)
...
- [Pin header](https://en.wikipedia.org/wiki/Pin_header): mua hàng rào đực đơn hàn vào lỗ cắm UART để nối với dây cắm (jumper wire).
- [Jump wire - Dây cắm test (Dupont wire)](https://en.wikipedia.org/wiki/Jump_wire): mua loại đầu cắm cái - cái (female - female) để nối từ cáp chuyển đổi USB-to-serial sang các chân pin header đã hàn trên bo mạch.
- [Multimeter - Đồng hồ vạn năng](https://en.wikipedia.org/wiki/Multimeter): dùng để đo điện압 (kiểm tra mức 3.3V/5V), kiểm tra thông mạch (chân GND, TX, RX) và dò đường mạch trên bo mạch router một cách an toàn.

> *Lưu ý: Phần hình ảnh thực tế và danh mục chi tiết các trang thiết bị đang sử dụng sẽ được cập nhật sau để anh em tham khảo (repo mang tính chất chia sẻ kỹ thuật, không có link mua bán thương mại).*
